    ...
    function FormatArray(arr)
    {
        ...
        for(let i=0;i<arr.length;i++)
        {
            ...
            if(arr[i].yearsOfExperience>1)
            {
                ...
                {
                    objFormated.fullName=arr[i].firstName+" "+arr[i].lastName;
                }
                else if(arr[i].firstName==null)
                {
                    obj2.fullName=arr[i].lastName;
                }else 
                {
                     objFormated.fullName=arr[i].firstName;
                }
            objFormated.tech=arr[i].tech;
...
const applicationsStatics = (arr) => {
    function getApplicantStatistics(applicants) {
        let result = {
          python_devs: 0,
          javaScript_devs: 0,
          dotNet_devs: 0,
        ...
        for (let i = 0; i < applicants.length; i++) {
          ...
          if (applicant.firstName === null && applicant.lastName === null && applicant.yearsOfExperience <= 1) {
