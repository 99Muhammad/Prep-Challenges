...
function square(arr) {
    ...
    let arrAfterSquare=arr.map((element)=> Math.pow(element,2));
    return arrAfterSquare;
}
// -------------------------------------------------------------------------------------------------------
...
function fullName(arr) {
    // write your code here
    const arr2=arr.map((ele)=> ele.firstName+" "+ele.lastName);
    return arr2;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    // write your code here
    const students2= arr.map((ele) =>ele.avg=parseFloat((ele.gradsList.reduce((acc, curr)=> acc + curr, 0)
    /(ele.gradsList.length)).toFixed(2)));
